...
(function(e, t) {
  ...
  b.Callbacks = function(e) {
    ...
    checkOn:!!a.value, optSelected:l.selected, enctype:!!o.createElement("form").enctype, html5Clone:"<:nav></:nav>" !== o.createElement("nav").cloneNode(!0).outerHTML, boxModel:"CSS1Compat" === o.compatMode, deleteExpando:!0, noCloneEvent:!0, inlineBlockNeedsLayout:!1, shrinkWrapBlocks:!1, reliableMarginRight:!0, boxSizingReliable:!0, pixelPosition:!1}, a.checked = !0, t.noCloneChecked = a.cloneNode(!0).checked, s.disabled = !0, t.optDisabled = !l.disabled;
    try {
      delete d.test
    }catch(h) {
      t.deleteExpando = !1
    ...
    return d.style.backgroundClip = "content-box", d.cloneNode(!0).style.backgroundClip = "", t.clearCloneStyle = "content-box" === d.style.backgroundClip, b(function() {
      ...
      "box-sizing:border-box;-moz-box-sizing:border-box;-webkit-box-sizing:border-box;padding:1px;border:1px;display:block;width:4px;margin-top:1%;position:absolute;top:1%;", t.boxSizing = 4 === d.offsetWidth, t.doesNotIncludeMarginInBodyOffset = 1 !== u.offsetTop, e.getComputedStyle && (t.pixelPosition = "1%" !== (e.getComputedStyle(d, null) || {}).top, t.boxSizingReliable = "4px" === (e.getComputedStyle(d, null) || {width:"4px"}).width, r = d.appendChild(o.createElement("div")), r.style.cssText = 
      d.style.cssText = s, r.style.marginRight = r.style.width = "0", d.style.width = "1px", t.reliableMarginRight = !parseFloat((e.getComputedStyle(r, null) || {}).marginRight)), typeof d.style.zoom !== i && (d.innerHTML = "", d.style.cssText = s + "width:1px;padding:1px;display:inline;zoom:1", t.inlineBlockNeedsLayout = 3 === d.offsetWidth, d.style.display = "block", d.innerHTML = "<div></div>", d.firstChild.style.width = "5px", t.shrinkWrapBlocks = 3 !== d.offsetWidth, t.inlineBlockNeedsLayout && 
  ...
  b.event = {global:{}, add:function(e, n, r, o, a) {
    ...
    if(v) {
      ...
      while(l--) {
        ...
        e.attachEvent("on" + g, f))), p.add && (p.add.call(e, d), d.handler.guid || (d.handler.guid = r.guid)), a ? h.splice(h.delegateCount++, 0, d) : h.push(d), b.event.global[g] = !0
      }
      e = null
    }
    ...
    if(l = f = i = i || o, 3 !== i.nodeType && 8 !== i.nodeType && !nt.test(g + b.event.triggered) && (g.indexOf(".") >= 0 && (m = g.split("."), g = m.shift(), m.sort()), u = 0 > g.indexOf(":") && "on" + g, n = n[b.expando] ? n : new b.Event(g, "object" == typeof n && n), n.isTrigger = !0, n.namespace = m.join("."), n.namespace_re = n.namespace ? RegExp("(^|\\.)" + m.join("\\.(?:.*\\.|)") + "(\\.|$)") : null, n.result = t, n.target || (n.target = i), r = null == r ? [n] : b.makeArray(r, [n]), p = 
    ...
    return null == e.pageX && null != n.clientX && (i = e.target.ownerDocument || o, a = i.documentElement, r = i.body, e.pageX = n.clientX + (a && a.scrollLeft || r && r.scrollLeft || 0) - (a && a.clientLeft || r && r.clientLeft || 0), e.pageY = n.clientY + (a && a.scrollTop || r && r.scrollTop || 0) - (a && a.clientTop || r && r.clientTop || 0)), !e.relatedTarget && u && (e.relatedTarget = u === e.target ? n.toElement : u), e.which || s === t || (e.which = 1 & s ? 1 : 2 & s ? 3 : 4 & s ? 2 : 0), 
    e
    ...
    _ + "*"), z = RegExp(R), X = RegExp("^" + O + "$"), U = {ID:RegExp("^#(" + F + ")"), CLASS:RegExp("^\\.(" + F + ")"), NAME:RegExp("^\\[name=['\"]?(" + F + ")['\"]?\\]"), TAG:RegExp("^(" + F.replace("w", "w*") + ")"), ATTR:RegExp("^" + P), PSEUDO:RegExp("^" + R), CHILD:RegExp("^:(only|first|last|nth|nth-last)-(child|of-type)(?:\\(" + _ + "*(even|odd|(([+-]|)(\\d*)n|)" + _ + "*(?:([+-]|)" + _ + "*(\\d+)|))" + _ + "*\\)|)", "i"), needsContext:RegExp("^" + _ + "*[>+~]|:(even|odd|eq|gt|lt|nth|first|last)(?:\\(" + 
  ...
  /^$|\/(?:java|ecma)script/i, Et = /^true\/(.*)/, St = /^\s*<!(?:\[CDATA\[|--)|(?:\]\]|--)>\s*$/g, At = {option:[1, "<select multiple='multiple'>", "</select>"], legend:[1, "<fieldset>", "</fieldset>"], area:[1, "<map>", "</map>"], param:[1, "<object>", "</object>"], thead:[1, "<table>", "</table>"], tr:[2, "<table><tbody>", "</tbody></table>"], col:[2, "<table><tbody></tbody><colgroup>", "</colgroup></table>"], td:[3, "<table><tbody><tr>", "</tr></tbody></table>"], _default:b.support.htmlSerialize ? 
  [0, "", ""] : [1, "X<div>", "</div>"]}, jt = dt(o), Dt = jt.appendChild(o.createElement("div"));
  ...
  "text xml":b.parseXML}, flatOptions:{url:!0, context:!0}}, ajaxSetup:function(e, t) {
    ...
    "string" != typeof p.data && (p.data = b.param(p.data, p.traditional)), qn(An, p, n, N), 2 === x) {
      return N
    }
    u = p.global, u && 0 === b.active++ && b.event.trigger("ajaxStart"), p.type = p.type.toUpperCase(), p.hasContent = !Cn.test(p.type), o = p.url, p.hasContent || (p.data && (o = p.url += (bn.test(o) ? "&" : "?") + p.data, delete p.data), p.cache === !1 && (p.url = wn.test(o) ? o.replace(wn, "$1_=" + vn++) : o + (bn.test(o) ? "&" : "?") + "_=" + vn++)), p.ifModified && (b.lastModified[o] && N.setRequestHeader("If-Modified-Since", b.lastModified[o]), b.etag[o] && N.setRequestHeader("If-None-Match", 
    b.etag[o])), (p.data && p.hasContent && p.contentType !== !1 || n.contentType) && N.setRequestHeader("Content-Type", p.contentType), N.setRequestHeader("Accept", p.dataTypes[0] && p.accepts[p.dataTypes[0]] ? p.accepts[p.dataTypes[0]] + ("*" !== p.dataTypes[0] ? ", " + Dn + "; q=0.01" : "") : p.accepts["*"]);
    for(i in p.headers) {
...
(function(e, t, i) {
  ...
  (function(e) {
    ...
    e.fn[s] = function(e) {
      ...
      return l.start = function() {
        ...
        l.start = function() {
          ...
          i !== n && (a.title = r.title, a.open(), o && a.write('<script>document.domain="' + o + '"\x3c/script>'), a.close(), t.location.hash = i)
        }
      }(), l
    }()
  }(e, this), function(e) {
    ...
    e.mobile.path = n = {uiStateKey:"&ui-state", urlParseRE:/^\s*(((([^:\/#\?]+:)?(?:(\/\/)((?:(([^:@\/#\?]+)(?:\:([^:@\/#\?]+))?)@)?(([^:\/#\?\]\[]+|\[[^\/\]@#?]+\])(?:\:([0-9]+))?))?)?)?((\/?(?:[^\/\?#]+\/+)*)([^\?#]*)))?(\?[^#]+)?)(#.*)?/, getLocation:function(e) {
      ...
      return t = t || (n.isPath(e) ? n.getLocation() : n.getDocumentUrl()), a = r ? n.stripHash(e) : e, a = n.isPath(l.hash) ? n.stripHash(l.hash) : a, s = a.indexOf(this.uiStateKey), s > -1 && (c = a.slice(s), a = a.slice(0, s)), i = n.makeUrlAbsolute(a, t), o = this.parseUrl(i).search, r ? ((n.isPath(d) || 0 === d.replace("#", "").indexOf(this.uiStateKey)) && (d = ""), c && -1 === d.indexOf(this.uiStateKey) && (d += c), -1 === d.indexOf("#") && "" !== d && (d = "#" + d), i = n.parseUrl(i), i = 
      i.protocol + "//" + i.host + i.pathname + o + d) : i += i.indexOf("#") > -1 ? c : "#" + c, i
    ...
    e.widget("mobile.dialog", e.mobile.widget, {options:{closeBtn:"left", closeBtnText:"Close", overlayTheme:"a", corners:!0, initSelector:":jqmData(role='dialog')"}, _handlePageBeforeShow:function() {
      ...
      var i, n, a = this;
      this._headerCloseButton && (this._headerCloseButton.remove(), this._headerCloseButton = null), "none" !== t && (n = "left" === t ? "left" : "right", i = e("<a href='#' class='ui-btn-" + n + "' data-" + e.mobile.ns + "icon='delete' data-" + e.mobile.ns + "iconpos='notext'>" + this.options.closeBtnText + "</a>"), this.element.children().find(":jqmData(role='header')").first().prepend(i), this._createComplete && e.fn.buttonMarkup && i.buttonMarkup(), this._createComplete = !0, i.bind("click", 
      function() {
        a.close()
    ...
    e.mobile.page.prototype.options.backBtnText = "Back", e.mobile.page.prototype.options.addBackBtn = !1, e.mobile.page.prototype.options.backBtnTheme = null, e.mobile.page.prototype.options.headerTheme = "a", e.mobile.page.prototype.options.footerTheme = "a", e.mobile.page.prototype.options.contentTheme = null, e.mobile.document.bind("pagecreate", function(t) {
      ...
      e(":jqmData(role='header'), :jqmData(role='footer'), :jqmData(role='content')", i).jqmEnhanceable().each(function() {
        ...
        if(d.addClass("ui-" + c), "header" === c || "footer" === c) {
          ...
          e.mobile.ns + "rel='back' data-" + e.mobile.ns + "icon='arrow-l'>" + n.backBtnText + "</a>").attr("data-" + e.mobile.ns + "theme", n.backBtnTheme || p).prependTo(d)), d.children("h1, h2, h3, h4, h5, h6").addClass("ui-title").attr({role:"heading", "aria-level":"1"})
        }else {
    ...
    e.fn.buttonMarkup = function(n) {
      ...
      for(var d = 0;r.length > d;d++) {
        ...
        for("popup" === o(b, l + "rel") && g.attr("href") && (b.setAttribute("aria-haspopup", !0), b.setAttribute("aria-owns", g.attr("href"))), f = e.data("INPUT" === b.tagName || "BUTTON" === b.tagName ? b.parentNode : b, "buttonElements"), f ? (b = f.outer, g = e(b), u = f.inner, p = f.text, e(f.icon).remove(), f.icon = null, x = f.hover, y = f.state) : (u = i.createElement(v.wrapperEls), p = i.createElement(v.wrapperEls)), m = v.icon ? i.createElement("span") : null, s && !f && s(), v.theme || 
        (v.theme = e.mobile.getInheritedTheme(g, "c")), c = "ui-btn ", c += x ? "ui-btn-hover-" + v.theme : "", c += y ? " ui-btn-" + y + "-" + v.theme : "", c += v.shadow ? " ui-shadow" : "", c += v.corners ? " ui-btn-corner-all" : "", v.mini !== t && (c += v.mini === !0 ? " ui-mini" : " ui-fullsize"), v.inline !== t && (c += v.inline === !0 ? " ui-btn-inline" : " ui-btn-block"), v.icon && (v.icon = "ui-icon-" + v.icon, v.iconpos = v.iconpos || "left", h = "ui-icon " + v.icon, v.iconshadow && (h += 
        " ui-icon-shadow")), v.iconpos && (c += " ui-btn-icon-" + v.iconpos, "notext" !== v.iconpos || g.attr("title") || g.attr("title", g.getEncodedText())), f && g.removeClass(f.bcls || ""), g.removeClass("ui-link").addClass(c), u.className = _, p.className = C, f || u.appendChild(p), m && (m.className = h, f && f.icon || (m.innerHTML = "&#160;", u.appendChild(m)));b.firstChild && !f;) {
    ...
    e.widget("mobile.listview", e.mobile.widget, e.extend({options:{theme:null, countTheme:"c", headerTheme:"b", dividerTheme:"b", icon:"arrow-r", splitIcon:"arrow-r", splitTheme:"b", corners:!0, shadow:!0, inset:!1, initSelector:":jqmData(role='listview')"}, _create:function() {
      ...
      if(t[r] === n && (t[r] = -1), l = l || ++t[r], e(a.find("li>ul, li>ol").toArray().reverse()).each(function(t) {
        ...
        i = !0, n = r.detach().wrap("<div " + c + "role='page' " + c + "url='" + b + "' " + c + "theme='" + v + "' " + c + "count-theme='" + _ + "'><div " + c + "role='content'></div></div>").parent().before("<div " + c + "role='header' " + c + "theme='" + d.headerTheme + "'><div class='ui-title'>" + g + "</div></div>").after(u ? e("<div " + c + "role='footer' " + c + "id='" + u + "'>") : "").parent().appendTo(e.mobile.pageContainer), n.page(), o = p.find("a:first"), o.length || (o = e("<a/>").html(f || 
        g).prependTo(p.empty())), o.attr("href", "#" + b)
    ...
    e.widget("mobile.slider", e.mobile.widget, e.extend({widgetEventPrefix:"slide", options:{theme:null, trackTheme:null, disabled:!1, initSelector:"input[type='range'], :jqmData(type='range'), :jqmData(role='slider')", mini:!1, highlight:!1}, _create:function() {
      ...
      r.find("option").length - 1 : parseFloat(r.attr("max")), C = t.parseFloat(r.attr("step") || 1), x = this.options.mini || r.jqmData("mini") ? " ui-mini" : "", y = i.createElement("a"), w = e(y), T = i.createElement("div"), D = e(T), P = this.options.highlight && !this.isToggleSwitch ? function() {
        var t = i.createElement("div");
        return t.className = "ui-slider-bg " + e.mobile.activeBtnClass + " ui-btn-corner-all", e(t).prependTo(D)
      }() : !1;
      if(y.setAttribute("href", "#"), T.setAttribute("role", "application"), T.className = [this.isToggleSwitch ? "ui-slider " : "ui-slider-track ", p, " ui-btn-down-", c, " ui-btn-corner-all", x].join(""), y.className = "ui-slider-handle", T.appendChild(y), w.buttonMarkup({corners:!0, theme:d, shadow:!0}).attr({role:"slider", "aria-valuemin":v, "aria-valuemax":_, "aria-valuenow":this._value(), "aria-valuetext":this._value(), title:this._value(), "aria-labelledby":g}), e.extend(this, {slider:D, handle:w, 
      type:h, step:C, max:_, min:v, valuebg:P, isRangeslider:u, dragging:!1, beforeStart:null, userModified:!1, mouseMoved:!1}), this.isToggleSwitch) {
      ...
      if(!isNaN(f)) {
        ...
        var D = 100 / ((C - _) / x);
        if(y = parseFloat(T.toFixed(5)), m === n && (m = r / ((C - _) / x)), m > 1 && b && (f = (y - _) * D * (1 / x)), 0 > f && (f = 0), f > 100 && (f = 100), _ > y && (y = _), y > C && (y = C), this.handle.css("left", f + "%"), this.handle[0].setAttribute("aria-valuenow", b ? y : v.eq(y).attr("value")), this.handle[0].setAttribute("aria-valuetext", b ? y : v.eq(y).getEncodedText()), this.handle[0].setAttribute("title", b ? y : v.eq(y).getEncodedText()), this.valuebg && this.valuebg.css("width", 
        f + "%"), this._labels) {
    ...
    e.widget("mobile.rangeslider", e.mobile.widget, {options:{theme:null, trackTheme:null, disabled:!1, initSelector:":jqmData(role='rangeslider')", mini:!1, highlight:!0}, _create:function() {
      ...
      slidebeforechange:"_change", blur:"_change", keyup:"_change"}), this._on({mousedown:"_change"}), this._on(this.element.closest("form"), {reset:"_handleReset"}), this._on(d, {vmousedown:"_dragFirstHandle"})
    ...
    e.widget("mobile.popup", e.mobile.widget, {options:{theme:null, overlayTheme:null, shadow:!0, corners:!0, transition:"none", positionTo:"origin", tolerance:null, initSelector:":jqmData(role='popup')", closeLinkSelector:"a:jqmData(rel='back')", closeLinkEvents:"click.popup", navigateEvents:"navigate.popup", closeEvents:"navigate.popup pagebeforechange.popup", dismissible:!0, history:!e.mobile.browser.oldIE}, _eatEventAndClose:function(e) {
      ...
      var t = {screen:e("<div class='ui-screen-hidden ui-popup-screen'></div>"), placeholder:e("<div style='display: none;'>\x3c!-- placeholder --\x3e</div>"), container:e("<div class='ui-popup-container ui-popup-hidden'></div>")}, i = this.element.closest(".ui-page"), a = this.element.attr("id"), o = this;
      this.options.history = this.options.history && e.mobile.ajaxEnabled && e.mobile.hashListeningEnabled, 0 === i.length && (i = e("body")), this.options.container = this.options.container || e.mobile.pageContainer, i.append(t.screen), t.container.insertAfter(t.screen), t.placeholder.insertAfter(this.element), a && (t.screen.attr("id", a + "-screen"), t.container.attr("id", a + "-popup"), t.placeholder.html("\x3c!-- placeholder for " + a + " --\x3e")), t.container.append(this.element), t.focusElement = 
      t.container, this.element.addClass("ui-popup"), e.extend(this, {_scrollTop:0, _page:i, _ui:t, _fallbackTransition:"", _currentTransition:!1, _prereqs:null, _isOpen:!1, _tolerance:null, _resizeData:null, _ignoreResizeTo:0, _orientationchangeInProgress:!1}), e.each(this.options, function(e, t) {
      ...
      transition:i.transition, classToRemove:"", screenClassToAdd:"in", containerClassToAdd:"in", applyTransition:!1, prereqs:this._prereqs})
    ...
    contentFixedToolbarOpen:"ui-panel-content-fixed-toolbar-open", contentFixedToolbarClosed:"ui-panel-content-fixed-toolbar-closed", animate:"ui-panel-animate"}, animate:!0, theme:"c", position:"left", dismissible:!0, display:"reveal", initSelector:":jqmData(role='panel')", swipeClose:!0, positionFixed:!1}, _panelID:null, _closeLink:null, _page:null, _modal:null, _panelInner:null, _wrapper:null, _fixedToolbar:null, _create:function() {
      ...
      if(!this._open) {
        var i = this, n = i.options, a = function() {
          i._page.off("panelclose"), i._page.jqmData("panel", "open"), !t && e.support.cssTransform3d && n.animate ? i.element.add(i._wrapper).on(i._transitionEndEvents, o) : setTimeout(o, 0), i.options.theme && "overlay" !== i.options.display && i._page.removeClass(i._pageTheme).addClass("ui-body-" + i.options.theme), i.element.removeClass(n.classes.panelClosed).addClass(n.classes.panelOpen), i._positionPanel(), i.options.theme && "overlay" !== i.options.display && i._wrapper.css("min-height", i._page.css("min-height")), 
          i._contentWrapOpenClasses = i._getPosDisplayClasses(n.classes.contentWrap), i._wrapper.removeClass(n.classes.contentWrapClosed).addClass(i._contentWrapOpenClasses + " " + n.classes.contentWrapOpen), i._fixedToolbarOpenClasses = i._getPosDisplayClasses(n.classes.contentFixedToolbar), i._fixedToolbar.removeClass(n.classes.contentFixedToolbarClosed).addClass(i._fixedToolbarOpenClasses + " " + n.classes.contentFixedToolbarOpen), i._modalOpenClasses = i._getPosDisplayClasses(n.classes.modal) + 
          " " + n.classes.modalOpen, i._modal && i._modal.addClass(i._modalOpenClasses)
        }, o = function() {
      ...
      if(this._open) {
        var i = this.options, n = this, a = function() {
          ...
          n.options.theme && "overlay" !== n.options.display && (n._page.removeClass("ui-body-" + n.options.theme).addClass(n._pageTheme), n._wrapper.css("min-height", "")), n.element.add(n._wrapper).off(n._transitionEndEvents, o), n.element.addClass(i.classes.panelClosed), n._wrapper.removeClass(n._contentWrapOpenClasses).addClass(i.classes.contentWrapClosed), n._fixedToolbar.removeClass(n._fixedToolbarOpenClasses).addClass(i.classes.contentFixedToolbarClosed), n._fixPanel(), n._unbindFixListener(), 
          e.mobile.resetActivePageHeight(), n._page.jqmRemoveData("panel"), n._trigger("close")
        };
      ...
      n ? this._open && (this._wrapper.removeClass(t.contentWrapOpen), this._fixedToolbar.removeClass(t.contentFixedToolbarOpen), this._page.jqmRemoveData("panel"), this._page.removeClass(t.pagePanelOpen), i && this._page.removeClass("ui-body-" + i).addClass(this._pageTheme)) : (this._wrapper.children().unwrap(), this._page.find("a").unbind("panelopen panelclose"), this._page.removeClass(t.pagePanel), this._open && (this._page.jqmRemoveData("panel"), this._page.removeClass(t.pagePanelOpen), i && 
      this._page.removeClass("ui-body-" + i).addClass(this._pageTheme), e.mobile.resetActivePageHeight())), this._panelInner.children().unwrap(), this.element.removeClass([this._getPanelClasses(), t.panelAnimate].join(" ")).off("swipeleft.panel swiperight.panel").off("panelbeforeopen").off("panelhide").off("keyup.panel").off("updatelayout"), this._closeLink.off("click.panel"), this._modal && this._modal.remove(), this.element.off(this._transitionEndEvents).removeClass([t.panelUnfixed, t.panelClosed, 
      t.panelOpen].join(" "))
    }}), e(i).bind("pagecreate create", function(t) {
    ...
    e.mobile.table.prototype.options.mode = "columntoggle", e.mobile.table.prototype.options.columnBtnTheme = null, e.mobile.table.prototype.options.columnPopupTheme = null, e.mobile.table.prototype.options.columnBtnText = "Columns...", e.mobile.table.prototype.options.classes = e.extend(e.mobile.table.prototype.options.classes, {popup:"ui-table-columntoggle-popup", columnBtn:"ui-table-columntoggle-btn", priorityPrefix:"ui-table-priority-", columnToggleTable:"ui-table-columntoggle"}), e.mobile.document.delegate(":jqmData(role='table')", 
    "tablecreate refresh", function(i) {
    ...
    e(t.document).trigger("mobileinit"), e.mobile.gradeA() && (e.mobile.ajaxBlacklist && (e.mobile.ajaxEnabled = !1), a.addClass("ui-mobile ui-mobile-rendering"), setTimeout(n, 5E3), e.extend(e.mobile, {initializePage:function() {
      ...
      }), e.mobile.firstPage = a.first(), e.mobile.pageContainer = e.mobile.firstPage.parent().addClass("ui-mobile-viewport"), o.trigger("pagecontainercreate"), e.mobile.showPageLoadingMsg(), n(), e.mobile.hashListeningEnabled && e.mobile.path.isHashValid(location.hash) && (e(r).is(':jqmData(role="page")') || e.mobile.path.isPath(s) || s === e.mobile.dialogHashKey) ? e.event.special.navigate.isPushStateEnabled() ? (e.mobile.navigate.history.stack = [], e.mobile.navigate(e.mobile.path.isPath(location.hash) ? 
      location.hash : location.href)) : o.trigger("hashchange", [!0]) : (e.mobile.path.isHashValid(location.hash) && (e.mobile.urlHistory.initialDst = s.replace("#", "")), e.event.special.navigate.isPushStateEnabled() && e.mobile.navigate.navigator.squash(t.parseLocation().href), e.mobile.changePage(e.mobile.firstPage, {transition:"none", reverse:!0, changeHash:!1, fromHashChange:!0}))
...
String.prototype.contains = function(a, b) {
  ...
  var c = this.toString(), d = a.toString();
  b && (c = c.toLowerCase(), d = d.toLowerCase());
...
var nu = {version:0.1};
nu.Storage = {};
nu.Storage.set = function(a, b) {
  var c = JSON.stringify(b);
  localStorage.setItem(a, c)
};
nu.Storage.get = function(a) {
...
nu.Utils.isNetworkAvailable = function() {
  return nu.Utils.isCordova() ? navigator.connection.type !== Connection.NONE : navigator.onLine
};
nu.Utils.isCordova = function() {
  return window.cordova
};
nu.Utils.isAndroid = function() {
  return nu.Utils.isCordova() ? "Android" === device.platform : navigator.userAgent.match("Android")
};
nu.Utils.isIOS = function() {
  return nu.Utils.isCordova() ? "iOS" === device.platform : navigator.userAgent.match(/(iPhone|iPod|iPad)/i)
};
nu.Utils.isOldAndroid = function() {
  return!nu.Utils.isAndroid() ? !1 : 4 > nu.Utils.getOSVersion()
};
nu.Utils.isOldIOS = function() {
  return!nu.Utils.isIOS() ? !1 : 5 > nu.Utils.getOSVersion()
};
nu.Utils.getOSVersion = function() {
  ...
  var a = navigator.userAgent;
  if(nu.Utils.isIOS()) {
    var b = a.indexOf("OS") + 2, a = a.slice(b), b = -1 === a.indexOf(")") ? 0 : a.indexOf(")"), a = a.substring(0, b), a = a.replace(/_/g, ".");
    return a = parseFloat(a)
  }
  return nu.Utils.isAndroid() ? (b = a.indexOf("Android") + 7, a = a.slice(b), b = -1 === a.indexOf(";") ? 0 : a.indexOf(";"), a = a.substring(0, b), a = parseInt(a)) : NaN
};
nu.Utils.loadLazyLib = function(a) {
  $.ajax({url:"js/lazy/" + a, dataType:"script", async:!1})
};
nu.Utils.blockEvent = function(a) {
  return!1
};
...
if(!JSON || !JSON.stringify || !JSON.parse) {
  JSON = {}, JSON.stringify = $.toJSON || function(a) {
    nu.Log.e("JSON.stringify could not be loaded : returning empty string !");
    return a instanceof Array ? "[]" : a instanceof Object ? "{}" : ""
  }, JSON.parse = $.evalJSON || function(a) {
    nu.Log.e("JSON.parse could not be loaded : returning empty object !");
    return{}
  }
}
nu.debug = {};
nu.debug.LogLevel = {ALL:"ALL", INFO:"INFO", ERROR:"ERROR", WARN:"WARN"};
nu.debug.LogItem = Object.subClass({init:function(a, b, c) {
  this.message = b;
  this.date = c;
  this.level = a
}, toString:function() {
...
nu.debug.Log = {};
nu.debug.Log.log = function(a, b) {
  if(a) {
    var c = a.toString(), d = null, e = new Date;
    switch(b) {
      ...
      case nu.debug.LogLevel.WARN:
        ...
        break;
      default:
        b = nu.debug.LogLevel.INFO, d = "info"
    }
    e = new nu.debug.LogItem(b, c, e);
    if(nu.debug.Log.level === nu.debug.LogLevel.ALL || nu.debug.Log.level.contains(b)) {
      if(nu.debug.Log.consoled) {
        console[d](c)
      }
      nu.debug.Log.stacked && (c = nu.debug.Log.stack, c || (c = {}, c[nu.debug.LogLevel.INFO] = [], c[nu.debug.LogLevel.WARN] = [], c[nu.debug.LogLevel.ERROR] = [], c[nu.debug.LogLevel.ALL] = [], nu.debug.Log.stack = c), c[b].unshift(e), c[nu.debug.LogLevel.ALL].unshift(e));
      nu.debug.Log.storaged && (c = nu.debug.Log.getStoraged(), c[b].unshift(e), c[nu.debug.LogLevel.ALL].unshift(e), nu.debug.Log.setStoraged(c))
    }
  }else {
    nu.debug.Log.e("nu.debug.Log called without parameter")
  }
};
nu.debug.Log.info = function(a) {
  nu.debug.Log.log(a, nu.debug.LogLevel.INFO)
};
nu.debug.Log.i = nu.debug.Log.info;
nu.debug.Log.error = function(a) {
  nu.debug.Log.log(a, nu.debug.LogLevel.ERROR)
};
nu.debug.Log.e = nu.debug.Log.error;
nu.debug.Log.warn = function(a) {
  nu.debug.Log.log(a, nu.debug.LogLevel.WARN)
};
nu.debug.Log.w = nu.debug.Log.warn;
nu.debug.Log.getStoraged = function() {
  var a = nu.Storage.get(nu.debug.Log.STORAGE_KEY);
  a || (a = {}, a[nu.debug.LogLevel.INFO] = [], a[nu.debug.LogLevel.ERROR] = [], a[nu.debug.LogLevel.WARN] = [], a[nu.debug.LogLevel.ALL] = [], nu.debug.Log.setStoraged(a));
  return a
};
nu.debug.Log.setStoraged = function(a) {
  nu.Storage.set(nu.debug.Log.STORAGE_KEY, a)
};
nu.debug.Log.listStoraged = function(a) {
  var b = nu.debug.Log.getStoraged()[a];
  if(b) {
    if(0 === b.length) {
      console.log("There is no logs with type" + a)
    }else {
      a !== nu.debug.LogLevel.ALL && console.log("List of logs with type " + a + " :");
      for(var c = 0, d = b.length;c < d;c++) {
        console.log("    * " + b[c])
      }
      a !== nu.debug.LogLevel.ALL && console.log("End of logs with type " + a)
    }
  }else {
    console.log("The type " + a + "is incorrect")
  }
};
nu.debug.Log.listStacked = function(a) {
  if(nu.debug.Log.stack) {
    a = a || nu.debug.LogLevel.ALL;
    var b = nu.debug.Log.stack[a];
    if(0 === b.length) {
      console.log("There is no logs with type" + a)
    }else {
      a !== nu.debug.LogLevel.ALL && console.log("List of logs with type " + a + " :");
...
nu.debug.Log.clearStoraged = function(a) {
  var b = nu.debug.Log.getStoraged();
  a === nu.debug.LogLevel.INFO || a === nu.debug.LogLevel.ERROR || a === nu.debug.LogLevel.WARN ? b[a] = [] : a === nu.debug.LogLevel.ALL && (b[nu.debug.LogLevel.INFO] = [], b[nu.debug.LogLevel.WARN] = [], b[nu.debug.LogLevel.ERROR] = []);
  nu.debug.Log.setStoraged(b)
};
nu.debug.Log.clearStacked = function(a) {
  var b = nu.debug.Log.stack;
  a === nu.debug.LogLevel.INFO || a === nu.debug.LogLevel.ERROR || a === nu.debug.LogLevel.WARN ? b[a] = [] : a === nu.debug.LogLevel.ALL && (b[nu.debug.LogLevel.ALL] = [], b[nu.debug.LogLevel.INFO] = [], b[nu.debug.LogLevel.WARN] = [], b[nu.debug.LogLevel.ERROR] = [])
};
nu.debug.Log.STORAGE_KEY = "nuborn.log";
nu.debug.Log.consoled = !0;
nu.debug.Log.storaged = !1;
nu.debug.Log.stacked = !0;
nu.debug.Log.level = nu.debug.LogLevel.ALL;
nu.pages = {};
nu.pages.PageEventsManager = Object.subClass({init:function() {
  this.pageHandlers = {};
  this.previousPageHandler = this.currentPageHandler = null;
  this.bindPageEvents()
}, bindPageEvents:function() {
  $(document).on("pagebeforecreate", "[data-role=page]", $.proxy(this, "pageBeforeCreate"));
  $(document).on("pageinit", "[data-role=page]", $.proxy(this, "pageInit"));
  $(document).on("pagecreate", "[data-role=page]", $.proxy(this, "pageCreate"));
  $(document).on("pagebeforechange", "[data-role=page]", $.proxy(this, "pageBeforeChange"));
  $(document).on("pagechange", "[data-role=page]", $.proxy(this, "pageChange"));
  $(document).on("pagebeforeload", "[data-role=page]", $.proxy(this, "pageBeforeLoad"));
  $(document).on("pageload", "[data-role=page]", $.proxy(this, "pageLoad"));
  $(document).on("pagebeforehide", "[data-role=page]", $.proxy(this, "pageBeforeHide"));
  $(document).on("pagebeforeshow", "[data-role=page]", $.proxy(this, "pageBeforeShow"));
  $(document).on("pageremove", "[data-role=page]", $.proxy(this, "pageRemove"));
  $(document).on("pagehide", "[data-role=page]", $.proxy(this, "pageHide"));
  $(document).on("pageshow", "[data-role=page]", $.proxy(this, "pageShow"))
...
}, registerPageHandler:function(a) {
  this.pageHandlers[a.settings.id] = a
}, getPageHandler:function(a) {
  var b = this.pageHandlers[a];
  b || console.log("-- Warning : no page handler for page '" + a + "' !");
  return b
}, getPageHandlerFromEvent:function(a) {
  return this.getPageHandler(a.currentTarget.id)
}, pageBeforeCreate:function(a, b) {
  var c = this.getPageHandlerFromEvent(a);
  c && (this.previousPageHandler = this.currentPageHandler, this.currentPageHandler = c, c.pageBeforeCreate(a, b))
  ...
  var c = this.getPageHandlerFromEvent(a);
  c && c.pageBeforeShow(a, b)
}, pageBeforeChange:function(a, b) {
  var c = this.getPageHandlerFromEvent(a);
  c && c.pageBeforeChange(a, b)
}, pageChange:function(a, b) {
  var c = this.getPageHandlerFromEvent(a);
  c && c.pageChange(a, b)
}, pageBeforeLoad:function(a, b) {
  var c = this.getPageHandlerFromEvent(a);
  c && c.pageBeforeLoad(a, b)
  ...
  var c = this.getPageHandlerFromEvent(a);
  c && c.pageBeforeHide(a, b)
}});
nu.pages.PageEventsManager.sharedManager = function() {
  nu.pages.PageEventsManager.SINGLETON_INSTANCE || (nu.pages.PageEventsManager.SINGLETON_INSTANCE = new nu.pages.PageEventsManager);
  return nu.pages.PageEventsManager.SINGLETON_INSTANCE
};
nu.pages.PageHandler = Object.subClass({init:function(a) {
  this.settings = $.extend(!0, {}, a);
  this.html = {};
  this.data = {};
  nu.pages.PageEventsManager.sharedManager().registerPageHandler(this)
}, pageBeforeCreate:function(a, b) {
  this.html.page = $(a.currentTarget)
}, pageInit:function(a, b) {
  console.log("page init of " + a.currentTarget.id);
  this.createHtmlElements();
  this.createDataElements()
}, pageCreate:function(a, b) {
  console.log("page create of '" + a.currentTarget.id + "'")
}, pageBeforeHide:function(a, b) {
  console.log("page before hide of '" + a.currentTarget.id + "'")
}, pageHide:function(a, b) {
  console.log("page hide of '" + a.currentTarget.id + "'")
}, pageBeforeShow:function(a, b) {
  console.log("page before show of '" + a.currentTarget.id + "'")
}, pageShow:function(a, b) {
  console.log("page show of '" + a.currentTarget.id + "'")
}, pageBeforeChange:function(a, b) {
  console.log("page before change of '" + a.currentTarget.id + "'")
}, pageChange:function(a, b) {
  console.log("page change of '" + a.currentTarget.id + "'")
}, pageBeforeLoad:function(a, b) {
  console.log("page before load of '" + a.currentTarget.id + "'")
}, pageLoad:function(a, b) {
  console.log("page load of '" + a.currentTarget.id + "'")
}, pageRemove:function(a, b) {
  console.log("page remove of '" + a.currentTarget.id + "'");
...
nu.widgets = {};
nu.widgets.SplashScreen = Object.subClass({init:function(a) {
  this.settings = a || {};
  this.settings.id || (this.settings.id = nu.widgets.SplashScreen.DEFAULT_ID);
  this.settings.url ? this.initWithUrl() : this.initWithId()
}, initWithId:function() {
  var a = $("<div>");
  a.prop("id", this.settings.id);
  a.addClass("fullscreen");
  this.element = a
}, initWithUrl:function() {
  var a = $.ajax({async:!1, url:this.settings.url});
  a.done(function(a) {
    a = $(a);
    var c = a.prop("id");
    "" !== c && (this.settings.id = c);
    a.addClass("fullscreen");
    this.element = a
  });
  a.fail(function() {
...
;(function() {
  ...
  define("cordova", function(require, exports, module) {
    ...
    var cordova = {define:define, require:require, addWindowEventHandler:function(event) {
    ...
    }, callbackId:Math.floor(Math.random() * 2E9), callbacks:{}, callbackStatus:{NO_RESULT:0, OK:1, CLASS_NOT_FOUND_EXCEPTION:2, ILLEGAL_ACCESS_EXCEPTION:3, INSTANTIATION_EXCEPTION:4, MALFORMED_URL_EXCEPTION:5, IO_EXCEPTION:6, INVALID_ACTION:7, JSON_EXCEPTION:8, ERROR:9}, callbackSuccess:function(callbackId, args) {
      try {
  ...
  define("cordova/commandProxy", function(require, exports, module) {
    var CommandProxyMap = {};
    module.exports = {add:function(id, proxyObj) {
  ...
  define("cordova/exec", function(require, exports, module) {
    var cordova = require("cordova"), channel = require("cordova/channel"), utils = require("cordova/utils"), jsToNativeModes = {IFRAME_NAV:0, XHR_NO_PAYLOAD:1, XHR_WITH_PAYLOAD:2, XHR_OPTIONAL_PAYLOAD:3}, bridgeMode, execIframe, execXhr, requestCount = 0, vcHeaderValue = null, commandQueue = [], isInContextOfEvalJs = 0;
    ...
    function massageArgsJsToNative(args) {
      ...
      args.forEach(function(arg, i) {
        if(utils.typeName(arg) == "ArrayBuffer") {
          ret.push({"CDVType":"ArrayBuffer", "data":encodeArrayBufferAsBase64(arg)})
        }else {
          ret.push(arg)
        }
      });
  ...
  define("cordova/platform", function(require, exports, module) {
    module.exports = {id:"ios", initialize:function() {
  ...
  define("cordova/plugin/Connection", function(require, exports, module) {
    module.exports = {UNKNOWN:"unknown", ETHERNET:"ethernet", WIFI:"wifi", CELL_2G:"2g", CELL_3G:"3g", CELL_4G:"4g", CELL:"cellular", NONE:"none"}
  });
  ...
  define("cordova/plugin/InAppBrowser", function(require, exports, module) {
    ...
    function InAppBrowser() {
      this.channels = {"loadstart":channel.create("loadstart"), "loadstop":channel.create("loadstop"), "loaderror":channel.create("loaderror"), "exit":channel.create("exit")}
    }
  ...
  define("cordova/plugin/accelerometer", function(require, exports, module) {
    ...
    var accelerometer = {getCurrentAcceleration:function(successCallback, errorCallback, options) {
      ...
      var frequency = options && options.frequency && typeof options.frequency == "number" ? options.frequency : 1E4;
      ...
      listeners.push(p);
      timers[id] = {timer:window.setInterval(function() {
        if(accel) {
          successCallback(accel)
        }
      }, frequency), listeners:p};
      if(running) {
        if(accel) {
          successCallback(accel)
        }
  ...
  define("cordova/plugin/battery", function(require, exports, module) {
    ...
    var Battery = function() {
      ...
      this.channels = {batterystatus:cordova.addWindowEventHandler("batterystatus"), batterylow:cordova.addWindowEventHandler("batterylow"), batterycritical:cordova.addWindowEventHandler("batterycritical")};
  ...
  define("cordova/plugin/compass", function(require, exports, module) {
    var argscheck = require("cordova/argscheck"), exec = require("cordova/exec"), utils = require("cordova/utils"), CompassHeading = require("cordova/plugin/CompassHeading"), CompassError = require("cordova/plugin/CompassError"), timers = {}, compass = {getCurrentHeading:function(successCallback, errorCallback, options) {
  ...
  define("cordova/plugin/contacts", function(require, exports, module) {
    ...
    var contacts = {find:function(fields, successCB, errorCB, options) {
  ...
  define("cordova/plugin/geolocation", function(require, exports, module) {
    ...
    function parseParameters(options) {
      var opt = {maximumAge:0, enableHighAccuracy:false, timeout:Infinity};
      if(options) {
    ...
    function createTimeout(errorCallback, timeout) {
      var t = setTimeout(function() {
        clearTimeout(t);
        t = null;
        errorCallback({code:PositionError.TIMEOUT, message:"Position retrieval timed out."})
      }, timeout);
      return t
    }
    var geolocation = {lastPosition:null, getCurrentPosition:function(successCallback, errorCallback, options) {
      ...
      var win = function(p) {
        ...
        var pos = new Position({latitude:p.latitude, longitude:p.longitude, altitude:p.altitude, accuracy:p.accuracy, heading:p.heading, velocity:p.velocity, altitudeAccuracy:p.altitudeAccuracy}, p.timestamp === undefined ? new Date : p.timestamp instanceof Date ? p.timestamp : new Date(p.timestamp));
      ...
      if(geolocation.lastPosition && options.maximumAge && (new Date).getTime() - geolocation.lastPosition.timestamp.getTime() <= options.maximumAge) {
        ...
        if(options.timeout === 0) {
          fail({code:PositionError.TIMEOUT, message:"timeout value in PositionOptions set to 0 and no cached Position object available, or cached Position object's age exceeds provided PositionOptions' maximumAge parameter."})
        }else {
  ...
  define("cordova/plugin/globalization", function(require, exports, module) {
    ...
    var globalization = {getPreferredLanguage:function(successCB, failureCB) {
  ...
  define("cordova/plugin/ios/Contact", function(require, exports, module) {
    var exec = require("cordova/exec"), ContactError = require("cordova/plugin/ContactError");
    module.exports = {display:function(errorCB, options) {
      if(this.id === null) {
  ...
  define("cordova/plugin/ios/contacts", function(require, exports, module) {
    var exec = require("cordova/exec");
    module.exports = {newContactUI:function(successCallback) {
  ...
  define("cordova/plugin/ios/notification", function(require, exports, module) {
    ...
    module.exports = {beep:function(count) {
  ...
  define("cordova/plugin/notification", function(require, exports, module) {
    ...
    module.exports = {alert:function(message, completeCallback, title, buttonLabel) {
  ...
  define("cordova/plugin/splashscreen", function(require, exports, module) {
    var exec = require("cordova/exec");
    var splashscreen = {show:function() {
