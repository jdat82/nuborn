define "nu.debug.Log", ( require, exports, module ) ->
    ...
    LocalStorageChannel = require "nu.debug.LocalStorageChannel"
    MemoryChannel = require "nu.debug.MemoryChannel"
    ConsoleChannel = require "nu.debug.ConsoleChannel"
