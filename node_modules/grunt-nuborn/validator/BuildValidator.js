		...
		switch (extension) 
		{
			...
			case extensions.all: 
				...
				if (config.data.templates) {
					if(scope === scopes.all) {
						templates.process(config.data.targets, config.data.templates[scopes.libs], scopes.libs);
						templates.process(config.data.targets, config.data.templates[scopes.app], scopes.app);
					} else {
						templates.process(config.data.targets, config.data.templates[scope], scope);
					}
				} else {
					grunt.log.writeln("No templates configuration");
				}
				if (config.data.javascript) {
					if(scope === scopes.all) {
						javascript.process(config.data.targets, config.data.javascript[scopes.libs], scopes.libs);
						javascript.process(config.data.targets, config.data.javascript[scopes.app], scopes.app);
					} else {
					...
					grunt.log.writeln("No javascript configuration");
				}
				break;
			...
			case extensions.all:
				...
				if (config.data.css) {
					if(scope === scopes.all) {
						css.process(config.data.targets, config.data.css[scopes.libs], scopes.libs);
						css.process(config.data.targets, config.data.css[scopes.app], scopes.app);
					} else {
						css.process(config.data.targets, config.data.css[scope], scope);
					}
				} else {
					grunt.log.writeln("No css configuration");
				}
				break;
			...
			case extensions.all:
				...
				if (config.data.html) {
					if(scope === scopes.all) {
						html.process(config.data.targets, config.data.html[scopes.libs], scopes.libs);
						html.process(config.data.targets, config.data.html[scopes.app], scopes.app);
					} else {
						html.process(config.data.targets, config.data.html[scope], scope);
					}
				} else {
					grunt.log.writeln("No html configuration");
				}
				break;
